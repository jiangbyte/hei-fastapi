...
from app.modules.profile.admin.service import AVATAR_MAX_SIZE, ProfileUserAdminService
from app.modules.profile.schema import AdminMeResponse, BindTargetRequest
