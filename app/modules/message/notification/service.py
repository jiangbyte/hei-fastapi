...
class MsgNotificationService:
    ...
    ) -> PageData[MsgNotificationSchema]:
    ...
    async def page_my_notifications(
        self, query: MyNotificationPageQuery, session
    ) -> PageData[MsgNotificationSchema]:
        account_type = session.account_type
        account_id = session.account_id
        items, total, read_id_set = await self.repo.page_my_notifications(
    ...
    async def _batch_enrich_profiles(
        self, schemas: list[MsgNotificationSchema]
    ) -> list[MsgNotificationSchema]:
