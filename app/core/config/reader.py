...
from app.core.config.crypto import decrypt_config_value
...
class ConfigReader:
    ...
    async def reload(self) -> None:
        """重新加载（管理后台修改配置后调用）。"""
        await self.load_all()
        from app.core.config.apply import apply_sys_config
        from app.core.storage.manager import clear_storage_cache
