...
def upgrade() -> None:
    ...
    op.create_table('msg_notice_read',
    sa.Column('id', sa.String(length=64), nullable=False, comment='主键'),
    ...
    sa.UniqueConstraint('notice_id', 'account_type', 'account_id', name='uq_msg_notice_read_account')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('msg_notice_read')
    op.drop_table('msg_notice')
